...
module "eks_cluster_iam_role" {
  source        = "git::https://github.com/MEGAVARSHINI85/terraform-modules.git//security/iam-role/1.0.0"
...
module "kms_key" {
  source = "git::https://github.com/MEGAVARSHINI85/terraform-modules.git//security/kms/1.0.0"
...
#EKS Node Group
module "node_group" {
  source                                 = "git::https://github.com/MEGAVARSHINI85/terraform-modules.git//container-compute/ng/1.0.0"
...
# EFS Provisioner
module "efs" {
  source             = "git::https://github.com/MEGAVARSHINI85/terraform-modules.git//storage/efs/1.0.0"
